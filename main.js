...
import LoudnessSample from './src/loudness.js';
import { createAudioMeter } from './src/audioMeter.js';
...
function createAudioCtxCtrl(buffer, callback) {
  ...
  function play() {
    ...
    if (loudnessSample == undefined) {
      loudnessSample = new LoudnessSample(context, buffer, callback, ParaCtrl.getLoudnessProperties(), 1);
    }
